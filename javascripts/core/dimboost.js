...
function softReset(bulk) {
  ...
  player = {
      ...
      secondCost: new Decimal(1),
      thirdCost: new Decimal(1),
      fourthCost: new Decimal(1),
      fifthCost: new Decimal(1),
      sixthCost: new Decimal(1),
      seventhCost: new Decimal(1),
      eightCost: new Decimal(1),
      firstAmount: new Decimal(1),
      secondAmount: new Decimal(1),
      thirdAmount: new Decimal(1),
      fourthAmount: new Decimal(1),
      firstBought: 0,
      secondBought: 0,
      thirdBought: 0,
      fourthBought: 0,
