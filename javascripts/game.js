...
var player = {
    ...
    tickSpeedCost: new Decimal(0.2),
    tickspeed: new Decimal(0.2),
    firstCost: new Decimal(1),
    secondCost: new Decimal(2),
    thirdCost: new Decimal(4),
    fourthCost: new Decimal(8),
    fifthCost: new Decimal(16),
    sixthCost: new Decimal(32),
    seventhCost: new Decimal(64),
    eightCost: new Decimal(128),
